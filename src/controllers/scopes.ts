...
export const dashboardScopes        = ['asset_pools:read', 'asset_pools:write', 'rewards:read', 'rewards:write', 'deposits:read', 'deposits:write', 'promotions:read', 'promotions:write'];
export const userScopes             = ['asset_pools:read', 'asset_pools:write', 'rewards:read', 'withdrawals:read', 'deposits:read', 'deposits:write'];
