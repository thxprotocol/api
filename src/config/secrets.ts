...
export const MAX_DAILY_CONTRACT_VERIFICATIONS = process.env.MAX_DAILY_CONTRACT_VERIFICATIONS;

export const POLYGON_TESTNET_API_ENDPOINT = process.env.POLYGON_TESTNET_API_ENDPOINT;
export const POLYGONSCAN_TESTNET_API_KEY = process.env.POLYGONSCAN_TESTNET_API_KEY;
